...
const Resume = forwardRef((props, ref) => {
  ...
  const sectionDiv = {
        ...
        <div className={styles.content}>
          {info.project?.details?.map((item) => (
            <div className={styles.item}>
              <div className={styles.projectUpperPart}>
                {item.title ? (
                  <p className={styles.title}>{item.title}</p>
                  ) : (
                  <span />
        ...
        <div className={styles.content}>
          {info.education?.details?.map((item) => (
            <div className={styles.item}>
              ...
              {item.score ? (
                <p className={styles.subTitle}>{item.score}</p>
              ) : (
                <span />
              )}
    ...
    [sections.aboutme]: (
      <div
        key={"aboutme"}
        draggable
        onDragOver={() => setTarget(info.aboutme?.id)}
  ...
  useEffect(() => {
    setColumns([
      [sections.aboutme,sections.education,sections.skill],
      [sections.workExp, sections.project, sections.achievement],
    ]);
  }, []);
